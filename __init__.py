...
if os.environ.get("FAL_KEY"):
  ascii_art = "\033[94m[ComfyUI_API-FalAI] Loaded API, \033[93mfound\033[0m\033[94m FAL_KEY Environment variable\033[0m"
else:
  ascii_art = "\033[94m[ComfyUI_API-FalAI] Loaded API, FAL_KEY Environment \033[91mmissing\033[0m\033[94m (did you export/set the variable?)\033[0m"
